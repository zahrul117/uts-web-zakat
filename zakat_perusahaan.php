...
<body>
    <h2>Hitung Zakat Perusahaan</h2>
    <form method="POST">
        <div class="form-container">
            <label>Nama:</label><br>
            <input type="text" name="nama" required><br><br>

            <label>Total Pendapatan (Rp):</label><br>
            <input type="text" id="penghasilan" name="penghasilan" required><br><br>

            <label>keuntungan Bersih:</label><br>
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        $nishab_bulanan = ($harga_emas * 0.25) / 12;
        ...
        echo "Nama: $nama<br>";
        echo "Total Pendapatan: Rp" . number_format($penghasilan, 0, ',', '.') . "<br>";
        echo "Keuntungan Bersih: Rp" . number_format($harga_emas, 0, ',', '.') . "<br>";
