...
<body>
    ...
    <form method="POST">
        <div class="form-container">
            ...
            <label>Nilai Barang Dagangan (Rp):</label><br>
            <input type="text" id="penghasilan" name="penghasilan" required><br><br>

            <label>Aset Dagang Bersih:</label><br>
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        echo "Nama: $nama<br>";
        echo "Nilai Barang Dagang: Rp" . number_format($penghasilan, 0, ',', '.') . "<br>";
        echo "Aset Dagang Bersih: Rp" . number_format($harga_emas, 0, ',', '.') . "<br>";
